...
new class extends Component
{
    ...
    // Logic untuk mengambil data aktivitas milik operator yang sedang login
    public function with()
    {
        return [
            'activities' => ProductionActivity::with('marketingOrder')
                ->where('user_id', Auth::id()) // Filter data milik saya sendiri
    ...
    {
        $activity = ProductionActivity::where('id', $id)
    ...
    // Menentukan layout yang digunakan
