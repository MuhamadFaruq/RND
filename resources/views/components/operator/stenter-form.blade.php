        ...
        <div class="max-w-4xl mx-auto px-4">
            <div class="bg-white rounded-[2.5rem] p-8 shadow-xl border border-slate-100">
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h2 class="text-xl font-black italic uppercase tracking-tighter text-slate-800">Stenter Process</h2>
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Heat Setting & Finishing</p>
                    </div>
                </div>

                <form wire:submit.prevent="submit" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-emerald-50/30 rounded-[2rem] border border-dashed border-emerald-100">
                        <div>
                        ...
                        <div class="flex flex-col justify-center">
                            <span class="text-[9px] font-black text-slate-400 uppercase">Art / Pelanggan</span>
                            <span class="text-sm font-black text-emerald-700 uppercase">{{ $art_no ?? '-' }} / {{ $pelanggan ?? '-' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">Suhu (°C)</label>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" wire:model="lebar_set" class="w-full rounded-xl border-slate-200">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black text-slate-400 uppercase mb-2">Gramasi</label>
                            <input type="number" wire:model="gramasi_set" class="w-full rounded-xl border-slate-200">
                        </div>
                    </div>
                    ...
                    <div class="pt-6">
                        <button type="submit" class="w-full bg-emerald-900 text-white py-4 rounded-2xl font-black italic uppercase tracking-tighter hover:bg-emerald-950 transition shadow-xl">
                            Simpan Data Stenter 🔥
                        </button>
                    </div>
                </form>
