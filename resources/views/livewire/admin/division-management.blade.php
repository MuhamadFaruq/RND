    ...
    <div class="p-4 md:p-8 flex-grow container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($divisions as $div)
                <div class="mkt-surface p-8 rounded-[3rem] border mkt-border shadow-2xl flex justify-between items-start group hover:border-indigo-600 transition-all duration-300 text-left">
                    ...
                    <div class="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        <button type="button" 
                                ...
                                class="p-3 bg-red-500/10 text-red-500 rounded-2xl hover:bg-red-600 hover:text-white transition-all">
                            🗑️
                        </button>
                    </div>
                </div>
