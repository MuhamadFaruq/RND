...
<div class="mkt-surface rounded-[2rem] p-8 mb-8 shadow-2xl border mkt-border backdrop-blur-md">
    ...
    <div class="flex justify-between items-center mb-10">
        <div>
            <h3 class="text-sm font-black uppercase italic text-brand-600 tracking-tighter">Production Analytics Hub</h3>
            <p class="text-[9px] text-slate-500 font-bold uppercase mt-1 italic">Real-time Performance Metrics</p>
        </div>
        
        <div class="flex items-center gap-4">
            <select wire:model.live="selectedDivision" class="mkt-input mkt-border mkt-text-muted rounded-2xl px-4 py-2.5 text-[9px] font-black uppercase italic focus:ring-2 focus:ring-brand-600 outline-none">
    ...
    <div class="flex justify-end mb-2">
        <div onclick="window.toggleProductionLine()" 
            ...
            <svg xmlns="http://www.w3.org/2000/svg" id="eye-icon-svg" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#ED1C24" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="transition-opacity duration-300">
        ...
        @if(($totalInput ?? 0) == 0)
            <div class="absolute inset-x-0 bottom-0 top-16 flex items-center justify-center mkt-surface opacity-90 backdrop-blur-[2px] rounded-xl z-10 border mkt-border">
                <div class="text-center">
                    <span class="text-[10px] font-black text-brand-600 uppercase tracking-widest italic animate-pulse">Waiting for production data...</span>
        ...
        <div class="grid grid-cols-6 md:grid-cols-12 lg:grid-cols-24 gap-2">
            @for($i = 0; $i < 24; $i++)
                @php 
                    ...
                    $colorClass = $count == 0 ? 'mkt-surface-alt' : 'bg-brand-600';
                @endphp
            ...
            <svg class="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 100 100">
                ...
                <defs>
                    <linearGradient id="grad" x1="0%" y1="0%" x2="0%" y2="100%">
                        ...
                        <stop offset="100%" style="stop-color:#ED1C24;stop-opacity:0" />
                    </linearGradient>
                </defs>
