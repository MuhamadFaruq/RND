        ...
        <div class="mb-12 mt-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                @foreach($divs as $div)
                    ...
                    @endphp
                    <div class="mkt-surface p-5 rounded-[2rem] border {{ $bgColor }} transition-all hover:scale-105 group relative overflow-hidden">
                        ...
                        <div class="absolute -right-4 -bottom-4 text-4xl opacity-5 font-black italic">{{ strtoupper(substr($div, 0, 1)) }}</div>
                    </div>
                @endforeach
            </div>
        </div>
