...
?>
{{-- 1. Menghapus min-h-screen dan py-16 yang menyebabkan jarak lebar --}}
<div x-data="{ openDetail: false, selected: {} }" class="bg-transparent italic tracking-tighter">
    <script src="https://cdn.tailwindcss.com"></script>

    <div class="max-w-[1600px] mx-auto">
        
        {{-- 2. Mengurangi margin-bottom (mb-8 ke mb-4) agar lebih rapat dengan judul dashboard --}}
        ...
        {{-- 3. Menghapus py-16 dan bg-slate-50 agar menyatu dengan background dashboard --}}
        <div class="animate-in fade-in duration-500">
            {{-- 4. Mengurangi padding internal form (p-12 ke p-8) agar tidak terlalu boros ruang --}}
            <form wire:submit.prevent="submit" class="bg-white p-8 rounded-[3rem] shadow-xl border border-slate-100">
                ...
                {{-- 5. Mengurangi margin antar section (mb-12 ke mb-8) --}}
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <input type="text" 
                                ...
                                class="w-full px-5 py-4 rounded-2xl border-slate-200 bg-slate-50 font-bold text-sm text-slate-700 focus:bg-white focus:ring-4 focus:ring-red-500/10 focus:border-red-600 transition-all outline-none"
                            >
                            {{-- Tambahkan pesan error di bawahnya agar jika kosong ada peringatan --}}
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <label class="block text-[11px] font-black uppercase text-slate-400 mb-2 tracking-widest">Target Gramasi</label>
                        <input type="text" wire:model="target_gramasi" class="w-full px-5 py-4 rounded-2xl border-slate-200 bg-slate-50 font-bold text-sm text-slate-700 focus:bg-white focus:ring-4 focus:ring-red-500/10 focus:border-red-600 transition-all outline-none" placeholder="Contoh: 280-290">
                    </div>
                    <div>
                        <label class="block text-[11px] font-black uppercase text-slate-400 mb-2 tracking-widest">Handfeel</label>
                        <select wire:model="handfeel" class="w-full px-5 py-4 rounded-2xl border-slate-200 bg-slate-50 font-bold text-sm text-slate-700 focus:bg-white focus:ring-4 focus:ring-red-500/10 focus:border-red-600 transition-all outline-none appearance-none">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-[11px] font-black uppercase text-slate-400 mb-2 tracking-widest">Treatment Khusus</label>
                        <input type="text" wire:model="treatment_khusus" placeholder="Contoh: Anti-Bacterial, UV Protection..." class="w-full px-5 py-4 rounded-2xl border-slate-200 bg-slate-50 font-bold text-sm text-slate-700 focus:bg-white focus:ring-4 focus:ring-red-500/10 focus:border-red-600 transition-all outline-none">
                    </div>
                        <div>
                        ...
                        <div>
                            <label class="text-[10px] font-bold text-slate-400 uppercase">Warna Kain</p>
                            <input type="text" wire:model="warna" class="w-full bg-slate-50 border-none rounded-2xl p-4 text-xs font-bold italic" placeholder="Contoh: Hitam Pekat">
