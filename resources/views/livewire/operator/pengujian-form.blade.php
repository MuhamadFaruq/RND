                ...
                <form wire:submit.prevent="submit" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" wire:model="operator" placeholder="MASUKKAN Nama Penguji"
                        ...
                        <div>
                            ...
                            <input type="date" wire:model="tanggal"
                                class="w-full mkt-surface-alt border mkt-border rounded-xl px-4 py-3 font-bold mkt-text focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6 pt-4 border-t mkt-border">
                        <div>
                            ...
                            <input type="number" wire:model="lebar" placeholder="MASUKKAN Hasil Lebar"
                                class="w-full mkt-surface-alt border mkt-border rounded-xl px-4 py-3 font-bold text-cyan-500 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all outline-none placeholder-slate-400">
                        </div>
                        <div>
                            <label class="block text-[10px] font-black mkt-text-muted uppercase mb-2 ml-1">Hasil Gramasi (Int)</label>
                            <input type="number" wire:model="gramasi" placeholder="MASUKKAN Hasil Gramasi"
                                class="w-full mkt-surface-alt border mkt-border rounded-xl px-4 py-3 font-bold text-cyan-500 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all outline-none placeholder-slate-400">
                        </div>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mkt-surface-alt border mkt-border p-6 rounded-[2rem] shadow-sm">
                        <div>
                            <label class="block text-[9px] font-black mkt-text-muted uppercase mb-2 ml-1">Shrinkage (Int)</label>
                            <input type="number" wire:model="shrinkage"
                                class="w-full mkt-surface border mkt-border rounded-xl px-4 py-3 font-black mkt-text focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all outline-none placeholder-slate-400"
                                placeholder="MASUKKAN Shrinkage">
                        </div>
                        <div>
                            <label class="block text-[9px] font-black mkt-text-muted uppercase mb-2 ml-1">Spirality (Int)</label>
                            <input type="number" wire:model="spirality"
                                class="w-full mkt-surface border mkt-border rounded-xl px-4 py-3 font-black mkt-text focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all outline-none placeholder-slate-400"
                                placeholder="MASUKKAN Spirality">
                        </div>
                        <div>
                            <label class="block text-[9px] font-black mkt-text-muted uppercase mb-2 ml-1">Skewness (Int)</label>
                            <input type="number" wire:model="skewness"
                                class="w-full mkt-surface border mkt-border rounded-xl px-4 py-3 font-black mkt-text focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all outline-none placeholder-slate-400"
                                placeholder="MASUKKAN Skewness">
                        </div>
                    </div>

                    <button type="submit"
                        class="w-full bg-cyan-600/80 backdrop-blur-md text-white py-5 rounded-2xl font-black uppercase text-xs shadow-lg transition-all hover:bg-cyan-600 hover:scale-105 group">
    ...
    <div x-show="showReq" 
        ...
        <div class="mkt-surface w-full max-w-3xl rounded-[3rem] border mkt-border shadow-2xl relative overflow-hidden italic flex flex-col max-h-[85vh]">
            ...
            <div class="px-10 py-8 mkt-surface border-t mkt-border flex justify-end">
                <button @click="showReq = false" class="px-12 py-4 bg-slate-800 text-white rounded-2xl font-black uppercase text-xs tracking-[0.2em] hover:bg-indigo-600 hover:shadow-xl transition-all active:scale-95 border border-white/5">
                    Tutup Detail
                </button>
            </div>
        </div>
