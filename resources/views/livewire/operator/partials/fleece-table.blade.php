...
<div class="mkt-surface p-4 md:p-5 rounded-2xl shadow-sm border mkt-border flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 group italic hover:border-amber-500 transition-all duration-300">
    <div class="flex items-center gap-3">
        <div class="bg-amber-600/20 text-amber-400 w-10 h-10 rounded-xl flex items-center justify-center font-black text-[10px] shadow-sm border border-amber-500/30 shrink-0">
            FL
        </div>
        <div class="text-left min-w-0">
            <span class="text-[9px] font-black text-amber-400 uppercase tracking-wider">#{{ $job->art_no }}</span>
            @if($job->is_urgent)
