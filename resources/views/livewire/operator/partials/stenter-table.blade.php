<div class="bg-white p-6 rounded-[2.5rem] shadow-sm border border-slate-100 flex justify-between items-center group italic hover:border-indigo-300 transition-all">
    <div class="flex items-center gap-6">
        <div class="bg-indigo-50 text-indigo-600 w-14 h-14 rounded-2xl flex items-center justify-center font-black text-xl shadow-sm">
            🔥
        </div>
        <div class="text-left">
            <span class="text-[10px] font-black text-indigo-600 uppercase tracking-widest">#{{ $job->sap_no }}</span>
            ...
            <div class="flex items-center gap-2 mt-1">
                ...
                <p class="text-[10px] font-black text-indigo-500 uppercase tracking-tighter">{{ $job->warna }}</p>
            </div>
        </div>
    </div>
