<div class="bg-white p-6 rounded-[2.5rem] shadow-sm border border-slate-100 flex justify-between items-center group italic hover:border-violet-300 transition-all">
    ...
    <div class="flex items-center gap-8">
        <div class="text-right border-r pr-8 border-slate-100">
            <p class="text-[9px] font-black text-slate-400 uppercase leading-none mb-1">Status</p>
            <p class="text-xs font-black text-violet-500 uppercase italic">Menunggu Final QE</p>
        </div>
