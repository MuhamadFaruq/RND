...
class FinishingForm extends Component
{
    // Data Identitas
    public $sap_no, $order_id, $pelanggan, $art_no, $warna;
    
    // Data Produksi Finishing
    public $no_mesin, $shift, $suhu_set, $speed;
    public $overfeed, $lebar_target, $gramasi_target;
    ...
    public function submit()
    {
        ...
        ProductionActivity::create([
            ...
            'lebar_actual' => $this->lebar_target,
        ...
        session()->flash('message', 'Data Heat Setting berhasil disimpan!');
        return redirect()->route('operator.logbook');
    }

    public function render()
    {
        return view('livewire.operator.finishing-form')
        ->layout('layouts.app');
    }
}